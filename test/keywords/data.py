...
def load_multiple_test_data(repositories) :
    ...
    for i in range(1,5) :
        ...
        key['Policy']                   = {'Version': '2012-10-17', 'Statement': [{'Sid': 'AllowRootAndServicePrincipal', 'Effect': 'Allow', 'Principal': {'AWS': ['arn:aws:iam::833168553325:root', 'arn:aws:iam::833168553325:user/principal']}, 'Action': 'kms:*', 'Resource': '*'}]}
